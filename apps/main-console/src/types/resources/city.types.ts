...
export function isCreateCityPayload(obj: object): obj is CreateCityPayload {
  return (
    ...
    ((obj as CreateCityPayload).sequence === undefined ||
      (obj as CreateCityPayload).sequence === null ||
      typeof (obj as CreateCityPayload).sequence === "number") &&
    ((obj as CreateCityPayload).disabled === undefined ||
      typeof (obj as CreateCityPayload).disabled === "boolean")
  );
}
...
export function isUpdateCityPayload(obj: object): obj is UpdateCityPayload {
  return (
    obj &&
    ((obj as UpdateCityPayload).stateId === undefined ||
      typeof (obj as UpdateCityPayload).stateId === "number") &&
    ((obj as UpdateCityPayload).name === undefined ||
      typeof (obj as UpdateCityPayload).name === "string") &&
    ((obj as UpdateCityPayload).documentRequired === undefined ||
      typeof (obj as UpdateCityPayload).documentRequired === "boolean") &&
    ((obj as UpdateCityPayload).code === undefined ||
      typeof (obj as UpdateCityPayload).code === "string") &&
    ((obj as UpdateCityPayload).sequence === undefined ||
      (obj as UpdateCityPayload).sequence === null ||
      typeof (obj as UpdateCityPayload).sequence === "number") &&
    ((obj as UpdateCityPayload).disabled === undefined ||
      typeof (obj as UpdateCityPayload).disabled === "boolean")
  );
}
...
export function isCityWithRelations(obj: object): obj is CityWithRelations {
  return (
    isCity(obj) &&
    "state" in obj &&
    ((obj as CityWithRelations).state === undefined ||
      (obj as CityWithRelations).state === null ||
      typeof (obj as CityWithRelations).state === "object")
  );
}
