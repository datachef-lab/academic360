...
const featureCards: FeatureCard[] = [
  ...
  },
  {
    ...
    description:
      "Configure subject-selection metas, related subjects, restricted groupings and whitelisted categories.",
    icon: SlidersHorizontal,
    href: "/dashboard/academic-setup/subject-configurations",
    iconColor: "text-pink-600",
    status: "Pending",
    items: "Related subjects, restrictions & metas",
  ...
  },
  {
    ...
    description:
      "Build promotion logic with promotion clauses, classes and appear types for class progression.",
    icon: Workflow,
