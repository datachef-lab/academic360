...
import type { ExamComponent } from "@academic/db/index";
  ...
  const handleSubmit = async (data: ExamComponent) => {
    ...
    try {
      if (selectedExamComponent) {
        ...
        toast.success("Exam component updated successfully");
      } else {
        await createExamComponent(data);
        toast.success("Exam component created successfully");
      }
      setIsFormOpen(false);
      ...
      console.log(err);
      toast.error("Failed to save exam component");
    } finally {
        ...
        <CardHeader className="flex flex-row items-center mb-3 justify-between border rounded-md p-4 bg-background">
          ...
          <div className="flex items-center gap-2">
            <Dialog open={isBulkUploadOpen} onOpenChange={setIsBulkUploadOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Bulk Upload Exam Components</DialogTitle>
                </DialogHeader>
