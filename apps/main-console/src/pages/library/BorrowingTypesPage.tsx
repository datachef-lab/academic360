...
import { BookOpenCheck, Edit, Loader2, PlusCircle, Search, Trash2 } from "lucide-react";
...
export default function BorrowingTypesPage() {
  ...
  return (
    <div className="p-2 sm:p-4">
      <LibraryPageHeader
        icon={BookOpenCheck}
        title="Borrowing Types"
        subtitle="Manage library borrowing types and search guideline settings."
        actions={
          <Button
