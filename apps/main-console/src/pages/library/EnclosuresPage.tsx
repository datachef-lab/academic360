...
import { Edit, FolderArchive, Loader2, PlusCircle, Search, Trash2 } from "lucide-react";
...
export default function EnclosuresPage() {
  ...
  return (
    <div className="p-2 sm:p-4">
      <LibraryPageHeader
        icon={FolderArchive}
        title="Enclosures / Attachments"
        subtitle="Manage enclosure and attachment master entries."
        actions={
          <Button
