...
export default function AdmissionConfigureDialog({
  ...
  const unmappedCourses = allCourses.filter(
    (c) => !mappedCourses.some((mc) => mc.courseId === c.id),
  );
          ...
          <div className="flex justify-between items-center gap-2">
            ...
            <div className="grid gap-2 w-1/3">
              ...
              <DatePicker
                selected={
                  admission?.startDate
                    ? admission.startDate instanceof Date
                      ? admission.startDate
                      : new Date(admission.startDate)
                    : null
                }
            ...
            <div className="grid gap-2 w-1/3">
              ...
              <DatePicker
                selected={
                  admission?.lastDate
                    ? admission.lastDate instanceof Date
                      ? admission.lastDate
                      : new Date(admission.lastDate)
                    : null
                }
