        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-white">
          <div className="grid grid-cols-2 text-white sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              <a href="/" className="flex justify-center lg:justify-start text-white font-bold">
                academic360*
              </a>
              <p className="py-8 text-sm text-white lg:max-w-xs text-center lg:text-left">
                Student Management System | Have any query ?
              </p>
            </div>
            ...
            <div className="lg:mx-auto text-left ">
              ...
              <ul className="text-sm  transition-all duration-500">
                <li className="mb-6">
                  <a href="javascript:;" className="text-white hover:text-white">
                    Home
                  </a>
                </li>
                <li className="mb-6">
