...
export const ReportColumns: ColumnDef<Report>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Badge
        variant="secondary"
        className="font-mono  bg-orange-50 text-orange-700 hover:bg-orange-50 py-1 px-2 drop-shadow-md"
      >
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Badge
        variant="secondary"
        className="font-mono  bg-indigo-50 text-indigo-700 hover:bg-indigo-50 py-1 px-2 drop-shadow-md"
      >
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge
          variant="outline"
          className={`${frameworkStyles[framework as keyof typeof frameworkStyles]} drop-shadow-md border-none text-xs py-1 px-2`}
        >
          {framework}
        </Badge>
      );
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="text-slate-700">{row.getValue("year")}</div>,
  },
  {
    ...
    cell: ({ row }) => <div className="text-slate-700">{row.getValue("semester")}</div>,
  },
  {
    accessorKey: "sgpa",
    header: ({ column }) => (
    ...
    cell: ({ row }) => <div className="text-slate-700">{row.getValue("sgpa")}</div>,
  },
  {
    accessorKey: "cgpa",
    header: ({ column }) => (
    ...
    cell: ({ row }) => <div className="text-slate-700">{row.getValue("cgpa")}</div>,
  },
  {
    ...
    cell: ({ row }) => <div className="text-slate-700">{row.getValue("totalFullMarks")}</div>,
  },
  {
    ...
    cell: ({ row }) => <div className="text-slate-700">{row.getValue("totalObtainedMarks")}</div>,
  },
  {
    ...
    cell: ({ row }) => <div className="text-slate-700">{row.getValue("totalCredit")}</div>,
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge
          variant={"outline"}
          className={`${gradeStyles[grade as keyof typeof gradeStyles] || "bg-gray-100 text-gray-800"} border-transparent font-medium`}
        >
          {grade}
        </Badge>
      );
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge
          variant={"outline"}
          className={`${isPass ? "bg-emerald-100 text-emerald-700" : "bg-rose-100 text-rose-700"} border-transparent`}
        >
          {/* {isPass ? (
