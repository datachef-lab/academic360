...
import type { AccommodationDto, AddressDto } from "@academic/db/dtos/user";
...
interface AccommodationFormProps {
  ...
  initialData?: AccommodationDto | null;
}
...
type AccommodationSubmissionData = Omit<Partial<AccommodationDto>, "startDate" | "endDate"> & {
  startDate?: string;
  endDate?: string;
};

// Utility to prepare data for backend submission
function prepareDataForSubmission(data: Partial<AccommodationDto>): AccommodationSubmissionData {
...
function normalizeAccommodationData(data: Partial<AccommodationDto>): Partial<AccommodationDto> {
  if (!data) return data;
