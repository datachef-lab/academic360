        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex min-h-10 h-auto items-center justify-between rounded-md border bg-inherit px-3 py-2 text-sm hover:bg-inherit [&_svg]:pointer-events-auto",
                ...
                <div className="flex justify-between items-center w-full">
                  <div
                    ...
                    style={
                      singleLine
                        ? {
                            // paddingBottom: "4px", // commented to remove extra padding on selected items
                          }
                        : {}
                    }
                  >
...
export type {
  MultiSelectOption as MultiSelectAdvanceOption,
  MultiSelectGroup as MultiSelectAdvanceGroup,
  MultiSelectProps as MultiSelectAdvanceProps,
};
