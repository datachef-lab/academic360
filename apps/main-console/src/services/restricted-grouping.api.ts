...
export type UpdateRestrictedGroupingMainInput =
  Partial<CreateRestrictedGroupingMainInput>;
...
export const restrictedGroupingApi = {
  ...
  async listRestrictedGroupingMainsPaginated(params: {
    ...
    const res = await api.get<
      ApiResponse<PaginatedResponse<RestrictedGroupingMainDto>>
    >(`${BASE_URL}`, { params });
    return res.data.payload;
  },
  async getRestrictedGroupingMain(id: number) {
    const res = await api.get<ApiResponse<RestrictedGroupingMainDto>>(
      `${BASE_URL}/${id}`,
    );
    return res.data.payload;
  },
  async createRestrictedGroupingMain(
    payload: CreateRestrictedGroupingMainInput,
  ) {
    const res = await api.post<ApiResponse<RestrictedGroupingMainDto>>(
      `${BASE_URL}`,
      payload,
    );
    return res.data.payload;
  },
  async updateRestrictedGroupingMain(
    id: number,
    payload: UpdateRestrictedGroupingMainInput,
  ) {
    const res = await api.put<ApiResponse<RestrictedGroupingMainDto>>(
      `${BASE_URL}/${id}`,
      payload,
    );
    return res.data.payload;
