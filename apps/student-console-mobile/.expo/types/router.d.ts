  ...
  export namespace ExpoRouter {
    export interface __routes<T extends string | object = string> {
      hrefInputParams:
        ...
        | {
            pathname: `/console${"/(tabs)"}/exams` | `/console/exams`;
            params?: Router.UnknownInputParams;
          }
        | {
            pathname: `/console${"/(tabs)"}/fees` | `/console/fees`;
            params?: Router.UnknownInputParams;
          }
        | { pathname: `/console${"/(tabs)"}` | `/console`; params?: Router.UnknownInputParams }
        | {
            pathname: `/console${"/(tabs)"}/library` | `/console/library`;
            params?: Router.UnknownInputParams;
          }
        | {
            pathname: `/console${"/(tabs)"}/study-notes` | `/console/study-notes`;
            params?: Router.UnknownInputParams;
          }
        ...
        | {
            pathname: `/console/academics/subject-selection-instructions`;
            params?: Router.UnknownInputParams;
          }
      ...
      hrefOutputParams:
        ...
        | {
            pathname: `/console/academics/cu-exam-form-upload`;
            params?: Router.UnknownOutputParams;
          }
