...
type SectionKey = "assignments" | "notes";

// Placeholder content — wire to the subject's real assignments/notes later.
...
export default function SubjectScreen() {
  ...
  const [section, setSection] = useState<SectionKey>("assignments");
  ...
  const name = params.name || "Subject";
  ...
  return (
    ...
    >
      ...
      <Text style={{ color: theme.text, opacity: 0.4 }} className="text-xs text-center mt-4">
        Sample content — assignments and notes will load from your subject
      </Text>
    </ScrollView>
  );
}
