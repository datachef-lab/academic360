...
} from "@/lib/services/application-form.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    if (id) {
      ...
      if (!form) {
        return NextResponse.json({ message: "Application form not found" }, { status: 404 });
      }
    ...
    return NextResponse.json({ message: "Either id or admissionId is required" }, { status: 400 });
  } catch (error) {
...
export async function PUT(req: NextRequest) {
  try {
    ...
    if (!id) {
      return NextResponse.json({ message: "Application form ID is required" }, { status: 400 });
    }
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ message: "Application form deleted successfully" }, { status: 200 });
  } catch (error) {
