...
export async function GET(req: NextRequest) {
  try {
    ...
    if (id) {
      ...
      if (!academicInfo) {
        return NextResponse.json({ message: "Academic info not found" }, { status: 404 });
      }
...
export async function PUT(req: NextRequest) {
  try {
    ...
    if (!id) {
      return NextResponse.json({ message: "Academic info ID is required" }, { status: 400 });
    }
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ message: "Academic info deleted successfully" }, { status: 200 });
  } catch (error) {
