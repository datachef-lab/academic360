...
import {
  findAdmissionById,
  findAdmissionByYear,
  getApplicationFormStats,
  getApplicationFormsByAdmissionId,
...
export async function GET(req: Request, { params }: { params: Promise<{ year: string }> }) {
  try {
    ...
    if (
      ...
      searchParams.get("religion") !== "All" &&
      searchParams.get("religion") !== "all"
    )
      filters.religion = searchParams.get("religion");
    if (
    ...
    if (
      ...
      searchParams.get("isGujarati") !== "All" &&
      searchParams.get("isGujarati") !== "all"
    )
      filters.isGujarati = searchParams.get("isGujarati") === "true";
    if (
      searchParams.get("formStatus") &&
    ...
    if (
      ...
      searchParams.get("boardUniversity") !== "All" &&
      searchParams.get("boardUniversity") !== "all"
    )
      filters.boardUniversity = searchParams.get("boardUniversity");
