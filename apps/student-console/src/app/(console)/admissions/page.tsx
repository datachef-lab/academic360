...
export default function AdmissionsPage() {
    ...
    async function fetchAdmissionAndCourses() {
      ...
      try {
        ...
        const coursesRes = await fetch(
          `/api/admissions/courses-map?admissionId=${admission.id}&withDetails=true`,
        );
  ...
  if (loading) {
    return (
      <div className={"min-h-screen flex items-center justify-center " + fontClass}>
        {animatedBg}
        {floatingShapes}
        <div className="text-lg text-gray-600 font-medium animate-pulse z-10">
          Loading admissions...
        </div>
      </div>
    );
    ...
    return (
      ...
      >
        ...
        <p className="text-gray-600 mb-4 z-10">
          Admissions for {CURRENT_YEAR} are currently closed or not available.
        </p>
  ...
  return (
    <div
      className={
        "max-h-screen overflow-y-auto overflow-x-hidden flex flex-col relative min-h-screen " +
        fontClass
      }
      style={{ height: "100vh" }}
    >
              ...
              <div className="flex flex-col gap-2">
                <div>
                  ...
                  <span className="ml-2 text-gray-600">
                    Minimum 50% marks in 12th standard from a recognized board. Applicants must have
                ...
                <div>
                  ...
                  <span className="ml-2 text-gray-600">
                    CBSE, ISC, State Boards, and other recognized national/international boards.
                  </span>
                </div>
                <div>
                  <span className="font-semibold text-gray-700">Other Information:</span>
                  <span className="ml-2 text-gray-600">
                    Scholarships available for meritorious students. Hostel facilities available on
                    request. For detailed brochure, contact the admissions office.
                  </span>
                </div>
              </div>
              <div className="text-xs text-gray-400 italic">
                * These details will vary by institute and admission year.
              </div>
            </div>
          </section>
        )}
