...
export default function SportsCategoriesPage() {
  ...
  const downloadTemplate = () => {
    const sampleData = [["name"], [""], ["Football"]];
  ...
  const downloadAll = () => {
    const exportData = data.map(({ name, disabled, createdAt }) => ({
      name,
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between gap-2 mb-6">
        <div className="flex gap-2">
          ...
          <Button variant="default" onClick={handleUploadSubmit} disabled={!selectedFile}>
