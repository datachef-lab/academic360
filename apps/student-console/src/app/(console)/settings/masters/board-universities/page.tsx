...
export default function BoardUniversitiesPage() {
  ...
  const handleEdit = (boardUniversity: BoardUniversityDto) => {
    ...
    setEditedSubjects(
      boardUniversity.subjects?.map((s) => ({
        id: s.id,
    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-col gap-4 mb-8">
        ...
        <div className="flex flex-wrap justify-between items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            {" "}
            {/* Group for add and download, adjusted gap */}
            ...
            {loading ? (
              <TableRow>
                <TableCell colSpan={8} className="text-center">
                  Loading board universities...
                </TableCell>
              </TableRow>
            ) : data.length === 0 ? (
              <TableRow>
                <TableCell colSpan={8} className="text-center">
                  No board universities found.
                </TableCell>
              </TableRow>
            ) : (
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-6xl max-h-[90vh] flex flex-col p-6 bg-white rounded-lg shadow-2xl border border-gray-100">
          {" "}
          {/* Increased max-width */}
          ...
          <div className="flex flex-col md:flex-row gap-6 py-4 overflow-hidden">
            <div className="flex flex-col space-y-4 pr-4 border-r border-gray-200 md:w-[300px]">
              {" "}
              {/* Left part: Inputs, set fixed width */}
              <div>
              ...
              <div>
                <Label htmlFor="editCode" className="text-sm font-medium text-gray-700">
                  Code
                </Label>
                <Input
                  id="editCode"
              ...
              <div>
                <Label htmlFor="editSequence" className="text-sm font-medium text-gray-700">
                  Sequence
                </Label>
                <Input
                  id="editSequence"
              ...
              <div>
                <Label htmlFor="editDegree" className="text-sm font-medium text-gray-700">
                  Degree
                </Label>
                <Select
            ...
            <div className="flex flex-col space-y-3 min-h-0 pl-4 flex-1 min-w-0">
              {" "}
              {/* Right part: Subjects Table, take remaining width */}
                ...
                <Button
                  ...
                  onClick={() =>
                    setEditedSubjects([
                      {
                        id: 0,
                        boardUniversityId: editingBoardUniversity?.id || 0,
                        name: "",
                        passingMarks: null,
                        disabled: false,
                  ...
                  <Table className="w-full">
                    <TableHeader className="sticky top-0 bg-gray-100 z-10 border-b border-gray-200">
                      <TableRow className="hover:bg-gray-100">
                        <TableHead className="w-[4%] py-3 px-1 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                          Sr. No.
                        </TableHead>
                        <TableHead className="w-[57%] py-3 px-1 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                          Subject Name
                        </TableHead>
                        <TableHead className="w-[23%] py-3 px-1 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                          Passing Marks
                        </TableHead>
                        <TableHead className="w-[16%] py-3 px-1 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                          Status
                        </TableHead>
                      </TableRow>
                    </TableHeader>
                        ...
                        filteredSubjects.map((subject, index) => (
                          ...
                          >
                            ...
                            <TableCell className="flex items-center justify-center">
                              {" "}
                              {/* Removed padding, added flex to center content */}
                              <Checkbox
