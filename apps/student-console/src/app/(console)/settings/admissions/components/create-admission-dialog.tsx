      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <LabelFixed htmlFor="year">Admission Year</LabelFixed>
            <select
              id="year"
          ...
          <div className="flex gap-4">
            <div className="grid gap-2 w-1/2">
              <LabelFixed htmlFor="start-date">Start Date</LabelFixed>
              <DatePicker
                selected={startDate}
            ...
            <div className="grid gap-2 w-1/2">
              <LabelFixed htmlFor="end-date">End Date</LabelFixed>
              <DatePicker
                selected={endDate}
          ...
          <div className="grid gap-2">
            <LabelFixed>Select Courses</LabelFixed>
                ...
                <div className="space-y-3">
                  {courses.map((course) => (
                    <div key={course.id} className="flex items-center space-x-3">
                      ...
                      />
                      <LabelFixed htmlFor={`course-${course.id}`} className="flex-1 cursor-pointer">
