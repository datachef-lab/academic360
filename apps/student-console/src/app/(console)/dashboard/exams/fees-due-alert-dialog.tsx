    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      ...
      <AlertDialogContent className="w-[95vw] max-w-6xl overflow-hidden rounded-lg p-0">
        <div className="flex max-h-[92vh] flex-col sm:min-h-[680px] sm:flex-row">
          ...
          {/* Right: static title bar + one scrollable area (notification, dues,
              declaration, actions) */}
          <div className="flex min-h-0 min-w-0 flex-1 flex-col">
            {/* Title stays put while the content below scrolls */}
            <AlertDialogHeader className="flex-shrink-0 border-b border-gray-100 px-6 pb-4 pt-6 text-left sm:px-8 sm:pt-8 sm:text-left">
              <AlertDialogTitle className="text-xl font-semibold text-rose-700">
                Important Notification:
              </AlertDialogTitle>
            </AlertDialogHeader>

            <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-6 pb-6 pt-4 sm:px-8 sm:pb-8">
