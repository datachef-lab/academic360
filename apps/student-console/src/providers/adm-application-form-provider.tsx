...
export interface ApplicationFormContextType {
  ...
  setApplicationForm: React.Dispatch<React.SetStateAction<ApplicationFormDto | null>>;
...
export const ApplicationFormContext = createContext<ApplicationFormContextType | undefined>(
  undefined,
);
...
export const ApplicationFormProvider: React.FC<ApplicationFormProviderProps> = ({
  ...
  const [applicationForm, setApplicationForm] = useState<ApplicationFormDto | null>(null);
    ...
    try {
      ...
      if ("applicationForm" in data) {
        setApplicationForm({
          ...
          generalInfo:
            data.applicationForm.generalInfo ||
            ({
  ...
  const fetchApplicationFormRefresh = useCallback(async (): Promise<ApplicationFormDto | null> => {
    ...
    try {
      const response = await axiosInstance.get<LoginCred | { applicationForm: ApplicationFormDto }>(
        "/api/auth/admission-refresh",
