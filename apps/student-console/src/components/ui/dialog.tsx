...
const OverlayP = DialogPrimitive.Overlay as any;
const ContentP = DialogPrimitive.Content as any;
const TitleP = DialogPrimitive.Title as any;
const DescriptionP = DialogPrimitive.Description as any;

const DialogOverlay = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Overlay>, any>(
  ({ className, ...props }, ref) => (
    <OverlayP
      ref={ref}
      className={cn(
...
const DialogContent = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Content>, any>(
