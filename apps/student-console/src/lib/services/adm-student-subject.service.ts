...
export async function createSubject(
  subject: Omit<StudentAcademicSubject, "id" | "createdAt" | "updatedAt">,
) {
  ...
  const [newSubject] = await dbPostgres.insert(studentAcademicSubjects).values(subject).returning();
...
export async function updateSubject(
  subject: Omit<StudentAcademicSubject, "createdAt" | "updatedAt">,
) {
