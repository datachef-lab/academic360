...
export const degreeLevelType = pgEnum("degree_level_type", [
  "SECONDARY",
  "HIGHER_SECONDARY",
  "UNDER_GRADUATE",
  "POST_GRADUATE",
]);
export const disabilityType = pgEnum("disability_type", [
  "VISUAL",
  "HEARING_IMPAIRMENT",
  "VISUAL_IMPAIRMENT",
  "ORTHOPEDIC",
...
export const paperModeType = pgEnum("paper_mode_type", [
  "THEORETICAL",
  "PRACTICAL",
  "VIVA",
  "ASSIGNMENT",
...
export const placeOfStayType = pgEnum("place_of_stay_type", [
  "OWN",
  "HOSTEL",
  "FAMILY_FRIENDS",
  "PAYING_GUEST",
...
export const studyMaterialAvailabilityType = pgEnum("study_material_availability_type", [
  "ALWAYS",
...
export const studyMetaType = pgEnum("study_meta_type", [
  "RESOURCE",
  "WORKSHEET",
  "ASSIGNMENT",
  "PROJECT",
]);
export const subjectCategoryType = pgEnum("subject_category_type", [
  "SPECIAL",
  "COMMON",
  "HONOURS",
  "GENERAL",
...
export const classes = pgTable(
  ...
  (table) => [unique("classes_sequence_unique").on(table.sequence)],
);
...
export const shifts = pgTable(
  ...
  (table) => [unique("shifts_sequence_unique").on(table.sequence)],
);

export const batchPapers = pgTable(
  "batch_papers",
  {
    id: serial().primaryKey().notNull(),
...
export const subjectMetadatas = pgTable(
  "subject_metadatas",
  {
    id: serial().primaryKey().notNull(),
...
export const marksheets = pgTable(
  "marksheets",
  {
    id: serial().primaryKey().notNull(),
...
export const offeredSubjects = pgTable(
  "offered_subjects",
  {
    id: serial().primaryKey().notNull(),
    subjectMetadataId: integer("subject_metadata_id_fk").notNull(),
...
export const studentPapers = pgTable(
  "student_papers",
  {
    id: serial().primaryKey().notNull(),
    studentId: integer("student_id_fk").notNull(),
...
export const specializations = pgTable(
  ...
  (table) => [unique("specializations_name_unique").on(table.name)],
);
...
export const subjectTypes = pgTable(
  ...
  (table) => [unique("subject_types_sequence_unique").on(table.sequence)],
);

export const boardUniversities = pgTable(
  "board_universities",
  {
    id: serial().primaryKey().notNull(),
    name: varchar({ length: 700 }).notNull(),
...
export const admissionAdditionalInfo = pgTable(
...
export const bloodGroup = pgTable(
  "blood_group",
  {
    id: serial().primaryKey().notNull(),
...
export const annualIncomes = pgTable(
  "annual_incomes",
  {
    id: serial().primaryKey().notNull(),
  ...
  (table) => [unique("annual_incomes_sequence_unique").on(table.sequence)],
);

export const admissionAcademicInfo = pgTable(
  "admission_academic_info",
  {
    id: serial().primaryKey().notNull(),
    applicationFormId: integer("application_form_id_fk").notNull(),
    boardUniversityId: integer("board_university_id_fk").notNull(),
...
export const languageMedium = pgTable(
  "language_medium",
  {
    id: serial().primaryKey().notNull(),
    name: varchar({ length: 255 }).notNull(),
...
export const admissionCourseApplications = pgTable(
...
export const admissionCourses = pgTable(
  "admission_courses",
  {
    id: serial().primaryKey().notNull(),
    admissionId: integer("admission_id_fk").notNull(),
...
export const admissionGeneralInfo = pgTable(
  "admission_general_info",
  {
    id: serial().primaryKey().notNull(),
    applicationFormId: integer("application_form_id_fk").notNull(),
...
export const nationality = pgTable(
  ...
  (table) => [unique("nationality_sequence_unique").on(table.sequence)],
);

export const sportsInfo = pgTable(
  "sports_info",
  {
    id: serial().primaryKey().notNull(),
...
export const studentAcademicSubjects = pgTable(
...
export const feesStructures = pgTable(
  "fees_structures",
  {
    id: serial().primaryKey().notNull(),
...
export const feesComponents = pgTable(
  "fees_components",
  {
    id: serial().primaryKey().notNull(),
...
export const feesHeads = pgTable(
  "fees_heads",
  {
    id: serial().primaryKey().notNull(),
    name: varchar({ length: 255 }).notNull(),
  ...
  (table) => [unique("fees_heads_sequence_unique").on(table.sequence)],
);
...
export const feesReceiptTypes = pgTable(
  "fees_receipt_types",
  {
    id: serial().primaryKey().notNull(),
    name: varchar({ length: 255 }).notNull(),
...
export const feesSlabMapping = pgTable(
  "fees_slab_mapping",
  {
    id: serial().primaryKey().notNull(),
    feesStructureId: integer("fees_structure_id_fk").notNull(),
...
export const feesSlab = pgTable(
  ...
  (table) => [unique("fees_slab_sequence_unique").on(table.sequence)],
);
...
export const studentFeesMappings = pgTable(
  "student_fees_mappings",
  {
    id: serial().primaryKey().notNull(),
    studentId: integer("student_id_fk").notNull(),
    feesStructureId: integer("fees_structure_id_fk").notNull(),
...
export const academicHistory = pgTable(
  "academic_history",
  {
    id: serial().primaryKey().notNull(),
    studentId: integer("student_id_fk").notNull(),
...
export const boardResultStatus = pgTable(
  "board_result_status",
  {
    id: serial().primaryKey().notNull(),
    name: varchar({ length: 255 }).notNull(),
  ...
  (table) => [unique("board_result_status_sequence_unique").on(table.sequence)],
);

export const academicIdentifiers = pgTable(
...
export const familyDetails = pgTable(
  "family_details",
  {
    id: serial().primaryKey().notNull(),
    studentId: integer("student_id_fk").notNull(),
...
export const disabilityCodes = pgTable(
  "disability_codes",
  {
    id: serial().primaryKey().notNull(),
  ...
  (table) => [unique("disability_codes_code_unique").on(table.code)],
);

export const transportDetails = pgTable(
  "transport_details",
  {
    id: serial().primaryKey().notNull(),
    studentId: integer("student_id_fk"),
