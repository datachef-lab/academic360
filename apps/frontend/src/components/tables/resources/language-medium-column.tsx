...
export const languageMediumColumns: ColumnDef<LanguageMedium>[] = [
  ...
  },
  {
    id: "actions",
    header: "Actions",
    cell: ({ row }) => <LanguageMediumActions languageMedium={row.original} />, // Use the new component
  },
];

const LanguageMediumActions = ({ languageMedium }: { languageMedium: LanguageMedium }) => {
