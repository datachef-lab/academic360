...
export function StudentSearchDataTable<TData extends SearchStudent, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow key={row.id} onClick={() => handleStudentClick(row.original.reg_number)} data-state={row.getIsSelected() && "selected"}>
