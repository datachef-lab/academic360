...
//   ShieldCheck,
// } from "lucide-react";
// import { AcademicIdentifier as AcademicIdentifierType } from "@/types/user/academic-identifier";
...
//     type: "text",
//     icon: <IdCard className="w-5 h-5 text-gray-500" />,
//   },
...
//   const [academicIdentifier, setAcademicIdentifier] = useState<AcademicIdentifierType>({
//     studentId: 0,
//     frameworkType: "CCF",
//     rfid: "",
//     stream: null,
...
//   console.log("streams:", data?.payload)
...
//         ))}
//         <select onChange={}>
//             {data?.payload.map((stream) =>
//             <option value={stream.id}>{stream?.degree?.name}</option>
...
//             className="w-auto text-white font-bold py-2 px-4 rounded bg-blue-600 hover:bg-blue-700"
//           >
//             Submit
//           </Button>
//         </div>
...
export default function AcademicIdentifier() {
  return <div>AcademicIdentifier</div>;
}
