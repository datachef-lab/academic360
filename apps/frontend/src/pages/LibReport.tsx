...
// // const LibReport = () => {
// //   return (
// //     <div className="p-6 space-y-6 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen">
// //       <div className="p-4 shadow-lg bg-white dark:bg-gray-800 rounded-2xl">
// //         <h2 className="text-xl font-bold mb-4">Fine Summary</h2>
// //         <p className="text-lg font-semibold">Total Outstanding Fine: ₹160</p>
// //         <p className="text-sm text-gray-600 dark:text-gray-400">₹10 per day after the due date.</p>
// //         <p className="text-sm text-red-500">Borrowing privileges may be suspended if not paid within 30 days.</p>
        
// //         <h3 className="text-lg font-semibold mt-4">Fine Breakdown</h3>
// //         <table className="w-full max-w-[300px] border-collapse border border-gray-300 dark:border-gray-700 mt-2">
// //           <thead>
...
// //                 <td className={`p-2 border border-gray-300 dark:border-gray-700 ${book.fine > 80 ? 'text-red-500' : book.fine > 50 ? 'text-yellow-500' : 'text-green-500'}`}>₹{book.fine}</td>
// //               </tr>
// //             ))}
// //           </tbody>
// //         </table>
...
// import React from "react";
// import { Download, Printer, AlertCircle, CheckCircle, XCircle } from "lucide-react";
...
//             <div className="p-4 shadow-lg bg-white dark:bg-gray-800 rounded-2xl">
//         <h2 className="text-xl font-bold mb-4">Overdue Books List</h2>
//         <table className="w-full max-w-[70%] border-collapse border border-gray-300 dark:border-gray-700">
//           <thead>
//             <tr className="bg-gray-200 dark:bg-gray-700">
//               <th className="p-2 border border-gray-300 dark:border-gray-700">Title</th>
//               <th className="p-2 border border-gray-300 dark:border-gray-700">Due Date</th>
...
//       <div className="flex gap-4">
//         <button className="bg-blue-70 text-white px-4 py-2 rounded-lg flex items-center gap-2">
//           <Download size={18} /> Download PDF
//         </button>
//         <button className="bg-green-600 text-white px-4 py-2 rounded-lg flex items-center gap-2">
//           <Printer size={18} /> Print Report
