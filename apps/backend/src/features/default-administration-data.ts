...
const examManagementSubAppModules: AppModuleDto[] = [
  ...
  },
  {
    name: "Exams",
    application: "MAIN_CONSOLE",
    description: "Manage exams, exam configuration, and exam details.",
    parentAppModule: defaultPrimaryAppModules.find(
      (m) => m.name === PRIMARY_APP_MODULE.Exams,
    )!,
    iconType: "lucide",
    iconValue: "BookOpen",
    image: "",
    componentKey: "EXAMS_LIST_PAGE",
    routePath: "/dashboard/exam-management/exams",
    moduleUrl: "/dashboard/exam-management/exams",
    isDynamic: false,
    isLayout: false,
    isProtected: true,
    isReadOnly: true,
  ...
  },
  {
    name: "Schedule Exam",
    application: "MAIN_CONSOLE",
    description: "Schedule exams, set exam dates, times, and duration.",
    parentAppModule: defaultPrimaryAppModules.find(
      (m) => m.name === PRIMARY_APP_MODULE.Exams,
    )!,
    iconType: "lucide",
    iconValue: "Calendar",
    image: "",
    componentKey: "SCHEDULE_EXAM_PAGE",
    routePath: "/dashboard/exam-management/schedule",
    moduleUrl: "/dashboard/exam-management/schedule",
    isDynamic: false,
    isLayout: false,
    isProtected: true,
    isReadOnly: true,
  ...
  },
  {
    ...
    application: "MAIN_CONSOLE",
    description:
      "Allocate exams to rooms, floors, and manage exam seating arrangements.",
    parentAppModule: defaultPrimaryAppModules.find(
      (m) => m.name === PRIMARY_APP_MODULE.Exams,
    )!,
    iconType: "lucide",
    iconValue: "Users",
    image: "",
    componentKey: "ALLOT_EXAM_PAGE",
    routePath: "/dashboard/exam-management/allot",
    moduleUrl: "/dashboard/exam-management/allot",
    isDynamic: false,
    isLayout: false,
    isProtected: true,
    isReadOnly: true,
  ...
  },
  {
    ...
    application: "MAIN_CONSOLE",
    description:
      "Manage floors, floor details, and floor maps for exam allotment.",
    parentAppModule: defaultPrimaryAppModules.find(
      (m) => m.name === PRIMARY_APP_MODULE.Exams,
    )!,
    iconType: "lucide",
    iconValue: "Building",
    image: "",
    componentKey: "FLOORS_PAGE",
    routePath: "/dashboard/exam-management/floors",
    moduleUrl: "/dashboard/exam-management/floors",
    isDynamic: false,
    isLayout: false,
    isProtected: true,
    isReadOnly: true,
  ...
  },
  {
    ...
    application: "MAIN_CONSOLE",
    description:
      "Manage rooms, room details, and room maps for exam allotment.",
    parentAppModule: defaultPrimaryAppModules.find(
      (m) => m.name === PRIMARY_APP_MODULE.Exams,
    )!,
    iconType: "lucide",
    iconValue: "DoorClosed",
    image: "",
    componentKey: "ROOMS_PAGE",
    routePath: "/dashboard/exam-management/rooms",
    moduleUrl: "/dashboard/exam-management/rooms",
    isDynamic: false,
    isLayout: false,
    isProtected: true,
    isReadOnly: true,
  ...
  },
  {
    ...
    application: "MAIN_CONSOLE",
    description:
      "Manage exam types, exam type details, and exam type configuration.",
    parentAppModule: defaultPrimaryAppModules.find(
      (m) => m.name === PRIMARY_APP_MODULE.Exams,
    )!,
    iconType: "lucide",
    iconValue: "Tag",
    image: "",
    componentKey: "EXAM_TYPE_PAGE",
    routePath: "/dashboard/exam-management/exam-type",
    moduleUrl: "/dashboard/exam-management/exam-type",
    isDynamic: false,
    isLayout: false,
    isProtected: true,
    isReadOnly: true,
