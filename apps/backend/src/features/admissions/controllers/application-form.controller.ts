...
export const createApplicationFormHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const getApplicationFormByIdHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
      ...
      res
        ...
        .json(
          new ApiResponse(
            ...
            "NOT_FOUND",
            null,
            `Application form with ID ${req.params.id} not found`,
          ),
        );
      return;
    }
...
export const getApplicationFormsByAdmissionIdHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    const result = await findApplicationFormsByAdmissionId(
...
export const updateApplicationFormHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
    ...
    res
      ...
      .json(
        new ApiResponse(
          ...
          "UPDATED",
          result,
          `Application form with ID ${req.params.id} updated successfully!`,
        ),
      );
  } catch (error) {
    handleError(error, res, next);
...
export const deleteApplicationFormHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
    ...
    res
      ...
      .json(
        new ApiResponse(
          ...
          "DELETED",
          { success: result },
          `Application form with ID ${req.params.id} deleted successfully!`,
        ),
      );
  } catch (error) {
    handleError(error, res, next);
