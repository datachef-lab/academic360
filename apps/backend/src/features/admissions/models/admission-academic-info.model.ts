...
import { boardResultStatusType, streamType } from "@/features/user/models/helper.js";
...
export const createAdmissionAcademicInfoSchema = createInsertSchema(admissionAcademicInfoModel);
