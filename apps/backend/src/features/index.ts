import { batchPaperRouter, batchRouter, documentRouter, marksheetRouter, statsRouter, streamRouter, studentPaperRouter, subjectMetadataRouter, subjectRouter } from "./academics/routes/index.js";
