...
export const createStudentFeesMapping = async (studentFeesMapping: StudentFeesMapping) => {
    try {
        const payload: StudentFeesMappingInsert = {
            ...
            instalmentId: (studentFeesMapping as any).instalmentId ? Number((studentFeesMapping as any).instalmentId) : undefined,
            ...
            amountPaid: (studentFeesMapping as any).amountPaid != null ? Number((studentFeesMapping as any).amountPaid) : undefined,
            ...
            transactionDate: (studentFeesMapping as any).transactionDate ? new Date((studentFeesMapping as any).transactionDate) : undefined,
            receiptNumber: (studentFeesMapping as any).receiptNumber ?? undefined,
        };
        const newStudentFeesMapping = await db.insert(studentFeesMappingModel).values(payload).returning();
...
export const updateStudentFeesMapping = async (id: number, studentFeesMapping: StudentFeesMapping) => {
    try {
        const payload: Partial<StudentFeesMappingInsert> = {
            studentId: (studentFeesMapping as any).studentId != null ? Number((studentFeesMapping as any).studentId) : undefined,
            feesStructureId: (studentFeesMapping as any).feesStructureId != null ? Number((studentFeesMapping as any).feesStructureId) : undefined,
            type: (studentFeesMapping as any).type,
            instalmentId: (studentFeesMapping as any).instalmentId != null ? Number((studentFeesMapping as any).instalmentId) : undefined,
            baseAmount: (studentFeesMapping as any).baseAmount != null ? Number((studentFeesMapping as any).baseAmount) : undefined,
            lateFee: (studentFeesMapping as any).lateFee != null ? Number((studentFeesMapping as any).lateFee) : undefined,
            totalPayable: (studentFeesMapping as any).totalPayable != null ? Number((studentFeesMapping as any).totalPayable) : undefined,
            amountPaid: (studentFeesMapping as any).amountPaid != null ? Number((studentFeesMapping as any).amountPaid) : undefined,
        ...
        const updatedStudentFeesMapping = await db.update(studentFeesMappingModel).set(payload).where(eq(studentFeesMappingModel.id, Number(id))).returning();
