...
import {
  getStudentFeesMappings,
  getStudentFeesMappingById,
  createStudentFeesMapping,
  updateStudentFeesMapping,
  deleteStudentFeesMapping,
} from "../services/student-fees-mapping.service.js";
import { handleError } from "@/utils/index.js";

export const getStudentFeesMappingsHandler = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const getStudentFeesMappingByIdHandler = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const createStudentFeesMappingHandler = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const updateStudentFeesMappingHandler = async (
  req: Request,
  res: Response,
) => {
  try {
    const id = parseInt(req.params.id);
    const updatedStudentFeesMapping = await updateStudentFeesMapping(
      id,
      req.body,
    );
...
export const deleteStudentFeesMappingHandler = async (
  req: Request,
  res: Response,
) => {
  try {
