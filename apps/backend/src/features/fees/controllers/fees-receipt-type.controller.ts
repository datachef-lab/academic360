...
import {
  getFeesReceiptTypes,
  getFeesReceiptTypeById,
  createFeesReceiptType,
  updateFeesReceiptType,
  deleteFeesReceiptType,
} from "../services/fees-receipt-type.service.js";
import { handleError } from "@/utils/index.js";

export const getFeesReceiptTypesHandler = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const getFeesReceiptTypeByIdHandler = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const createFeesReceiptTypeHandler = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const updateFeesReceiptTypeHandler = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const deleteFeesReceiptTypeHandler = async (
  req: Request,
  res: Response,
) => {
  try {
