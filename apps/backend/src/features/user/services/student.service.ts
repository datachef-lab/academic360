...
import { findAcademicHistoryByStudentId, removeAcademicHistory } from "./academicHistory.service.js";
import {
    addAcademicIdentifier,
    findAcademicIdentifierByStudentId,
    removeAcademicIdentifier,
    saveAcademicIdentifier,
} from "./academicIdentifier.service.js";
...
export async function findAllStudent(
    ...
    const studentsResponse = await findAll<StudentType>(
        studentModel,
        page,
        pageSize,
    );
