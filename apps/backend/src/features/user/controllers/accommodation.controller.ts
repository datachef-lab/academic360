...
} from "@/features/user/services/accommodation.service.js";
...
export const createAccommodation = async (
  ...
  try {
    ...
    const newAccommodation = await addAccommodation(
      req.body as AccommodationType,
    );
    if (!newAccommodation) {
      res
        .status(409)
        .json(
          new ApiResponse(
            ...
            "CONFLICT",
            null,
            "Accommodation already exists for this student",
          ),
        );
      return;
    }
    res
      ...
      .json(
        new ApiResponse(
          ...
          "SUCCESS",
          newAccommodation,
          "New accommodation is added to db!",
        ),
      );
  } catch (error) {
      ...
      res
        ...
        .json(
          new ApiResponse(
            ...
            "NOT_FOUND",
            null,
            `accommodation of ID ${id} not found`,
          ),
        );
      return;
    }
    res
      ...
      .json(
        new ApiResponse(
          ...
          "SUCCESS",
          foundAccommodation,
          "Fetched accommodation successfully!",
        ),
      );
  } catch (error) {
    handleError(error, res, next);
...
export const getAccommodationByStudentId = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
      ...
      res
        ...
        .json(
          new ApiResponse(
            ...
            "NOT_FOUND",
            null,
            `accommodation of studentId: ${studentId} not found`,
          ),
        );
      return;
    }
  ...
  try {
    ...
    if (!updatedAccommodation) {
      res
        .status(404)
        .json(
          new ApiResponse(404, "NOT_FOUND", null, "accommodation not found"),
        );
      return;
    }
    res
  ...
  try {
    ...
    if (!isDeleted) {
      res
        .status(500)
        .json(
          new ApiResponse(500, "ERROR", null, "Failed to delete accommodation"),
        );
      return;
    }
    res
...
export const deleteAccommodationByStudentId = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
      ...
      res
        ...
        .json(
          new ApiResponse(
            ...
            "NOT_FOUND",
            null,
            `accommodation for student ID ${studentId} not found`,
          ),
        );
      return;
    }
...
export const getAllAccommodationsController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
    ...
    res
      ...
      .json(
        new ApiResponse(
          ...
          "SUCCESS",
          accommodations,
          "Fetched all accommodations successfully!",
        ),
      );
  } catch (error) {
    handleError(error, res, next);
