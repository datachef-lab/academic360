...
// export const getAllReports = async (req: Request, res: Response, next: NextFunction) => {
//     try {
//         const {page, pageSize, searchText, stream, framework, year, semester} = req.query;
...
//         // const semester = typeof req.query.semester === "string" ? parseInt(req.query.semester, 10) : undefined;

//         if (isNaN(page) || isNaN(pageSize) || page < 1 || pageSize < 1) {
//             res.status(400).json(new ApiResponse(400, "BAD_REQUEST", null, "Invalid page or pageSize."));
//         }

//         const reportsData = await getReports({ page, pageSize, searchText, stream, framework, year, semester });
//         if(!reportsData) {
...
export const getAllReports = async (req: Request, res: Response, next: NextFunction) => {
    ...
    //     if (isNaN(page) || isNaN(pageSize) || page < 1 || pageSize < 1) {
    //  res.status(400).json(
    //             new ApiResponse(400, "BAD_REQUEST", null, "Invalid page or pageSize.")
    //         );
    //     }
