...
export const createEmergencyContact = async (
  ...
  try {
    ...
    const newEmergencyContact = await addEmergencyContact(
    ...
    res
      ...
      .json(
        new ApiResponse(
          ...
          "SUCCESS",
          newEmergencyContact,
          "New Emergency Contact is added to db!",
        ),
      );
  } catch (error) {
      ...
      res
        ...
        .json(
          new ApiResponse(
            ...
            "NOT_FOUND",
            null,
            `Emergency Contact of ID ${id} not found`,
          ),
        );
      return;
    }
    res
      ...
      .json(
        new ApiResponse(
          200,
          "SUCCESS",
          foundEmergencyContact,
          "Fetched Emergency Contact successfully!",
        ),
      );
  } catch (error) {
    handleError(error, res, next);
...
export const getEmergencyContactByStudentId = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
...
export const updateEmergencyContact = async (
  ...
  try {
    ...
    const updatedEmergencyContact = await updateEmergencyContactService(
      id,
      req.body as EmergencyContact,
    );
...
export const deleteEmergencyContactByStudentId = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
...
export const getAllEmergencyContactsController = async (
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> => {
    ...
    res
      ...
      .json(
        new ApiResponse(
          ...
          "SUCCESS",
          contacts,
          "Fetched all emergency contacts successfully!",
        ),
      );
  } catch (error) {
    handleError(error, res, next);
