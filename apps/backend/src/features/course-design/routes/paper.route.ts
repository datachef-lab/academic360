...
import { createPaperHandler, deletePaperHandler, getAllPapersHandler, getPaperByIdHandler, updatePaperHandler } from "../../course-design/controllers/paper.controller.js";
