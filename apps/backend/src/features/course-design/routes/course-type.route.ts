...
import { createCourseTypeHandler, deleteCourseTypeHandler, getAllCourseTypesHandler, getCourseTypeByIdHandler, updateCourseTypeHandler, bulkUploadCourseTypesHandler } from "../../course-design/controllers/course-type.controller.js";
...
router.post("/bulk-upload", uploadExcelMiddleware, bulkUploadCourseTypesHandler);
