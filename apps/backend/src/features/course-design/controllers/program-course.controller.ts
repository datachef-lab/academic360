...
export const createProgramCourseHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
    ...
    res
      ...
      .json(
        new ApiResponse(
          ...
          "SUCCESS",
          created,
          "Program course created successfully!",
        ),
      );
  } catch (error) {
...
export const getProgramCourseByIdHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
      ...
      return res
        ...
        .json(
          new ApiResponse(
            ...
            "NOT_FOUND",
            null,
            `Program course with ID ${id} not found`,
          ),
        );
    res
      .status(200)
      .json(
        new ApiResponse(
          ...
          "SUCCESS",
          programCourse,
          "Program course fetched successfully",
        ),
      );
  } catch (error) {
    handleError(error, res, next);
...
export const getAllProgramCoursesHandler = async (
  _req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const updateProgramCourseHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    ...
    if (!updated) {
      res
        .status(404)
        .json(
          new ApiResponse(404, "NOT_FOUND", null, "Program course not found"),
        );
      return;
    }
    res
...
export const deleteProgramCourseHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const bulkUploadProgramCoursesHandler = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    ...
    const result = await bulkUploadProgramCourses(
      req.file.path,
      io,
      uploadSessionId,
    );
