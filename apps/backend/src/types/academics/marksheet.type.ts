...
export interface MarksheetPaperComponentMappingDto
  extends Omit<MarksheetPaperComponentMapping, "paperComponentId"> {
  paperComponent: PaperComponentDto;
}
export interface MarksheetPaperDto
  extends Omit<
...
export interface MarksheetDto
  extends Omit<Marksheet, "batchStudentMappingId" | "classId"> {
  name: string;
  class: Class;
  batch: BatchDto;
