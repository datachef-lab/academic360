...
import { feeGroupPromotionMappingApprovalTypeEnum } from "@/schemas/enums";
...
export const feeGroupPromotionMappingModel = pgTable("fee_group_promotion_mappings", {
    ...
    approvalType: feeGroupPromotionMappingApprovalTypeEnum().default("SYSTEM").notNull(),
    approvalUserId: integer("approval_user_id_fk")
